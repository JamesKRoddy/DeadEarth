...
[CustomEditor(typeof(AIWaypointNetwork))] //edits this class
public class AIWaypointNetworkEditor : Editor {

    //put in a custom inspector
    public override void OnInspectorGUI()
    {
        ...
        if (network.DisplayMode == PathDisplayMode.Paths)
        {
            ...
            network.UIEnd = EditorGUILayout.IntSlider("Waypoint Start", network.UIEnd, 0, network.Waypoints.Count - 1);
        }
        DrawDefaultInspector();//default inspector format hide the ones you want to edit
    }
